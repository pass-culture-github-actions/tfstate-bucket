...
function npmRunPath(options = {}) {
	...
	let previous;
	const execPathString = execPath instanceof URL ? external_node_url_.fileURLToPath(execPath) : execPath;
	...
	result.push(external_node_path_.resolve(cwdString, execPathString, '..'));
